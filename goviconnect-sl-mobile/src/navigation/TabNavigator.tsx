...
import { AIHome, CropDoctorUpload, CropDoctorResult, DiagnosisHistory, DiagnosisDetail, NearbyShopsMap, NearbyShopDetail, PriceForm, PriceResult, PredictionHistory, PredictionDetail } from '../screens/ai';
...
const AIStackNavigator = () => (
    <AIStack.Navigator screenOptions={{ headerShown: false }}>
        ...
        <AIStack.Screen name="DiagnosisDetail" component={DiagnosisDetail} />
        <AIStack.Screen name="NearbyShopsMap" component={NearbyShopsMap} />
        <AIStack.Screen name="NearbyShopDetail" component={NearbyShopDetail} />
