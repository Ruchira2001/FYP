...
// Auth Screens - Reuse existing auth screens temporarily
...
const MainNavigator = () => (
    <RootStack.Navigator screenOptions={{ headerShown: false }}>
        ...
        <RootStack.Screen name="ExpertChatsList" component={ExpertChatDetail} />
        ...
        <RootStack.Screen name="ExpertDiagnosisReviews" component={ExpertKnowledgeBase} />
